...
$requiredFiles = @(
  ...
  'labs\README.md',
  'astro.config.mjs',
  'labs\lab-00-project-init\README.md',
  'labs\lab-05b-swarm-to-green\README.md'
)
...
$expectedFiles = @(
  ...
  '.claude\skills\public-site-safe\SKILL.md',
  '.opencode\agents\backend.md',
  'docs\STATUS.md.example',
  'docs\OPEN_LOOPS.md.example',
  'docs\handoffs\TEMPLATE.md'
)
foreach ($ex in $expectedFiles) {
