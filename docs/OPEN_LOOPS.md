...
| L3 | Contact: length limit + ไม่ echo email ใน response 201 | OpenCode | P1 | Lab 05 | D5 · ทำที่ `contact.ts` (lab test คาด `insertContact` คืน email) · ดู handoff `05-claude-to-opencode.md` |
