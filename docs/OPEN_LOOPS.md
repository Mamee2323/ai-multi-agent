...
|---|---|---|---|---|---|
| L7 | สร้าง issue D8 ผ่าน GitHub MCP (หลักฐาน Lab 03) · body `issue-bodies/07-fe-seo-jsonld.md` | human | P0 | ก่อน Lab 04 | โหลด token จาก `.env` แล้วเปิด `claude` ใหม่ |
...
| L3 | Contact: length limit + ไม่ echo email ใน response 201 | OpenCode | P1 | Lab 05 | #6 · D5 · ทำที่ `contact.ts` (lab test คาด `insertContact` คืน email) · ดู handoff `05-claude-to-opencode.md` |
